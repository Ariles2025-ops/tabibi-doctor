...
(function () {
  ...
  const TR = {
    fr: {
      ...
      pwl_p2: 'Averti dès le lancement',
      ...
      // [CAS GRAVE 2026] page cas-grave.html (concierge MVP)
      cg_title_long: 'Cas grave — orientation vérifiée | Tabibi',
      cg_back_home: 'Accueil',
      cg_h1: 'Un cas grave ou complexe ?',
      cg_subtitle: 'Tabibi vous aide à trouver le bon spécialiste. Cas vérifié, orientation sans commission.',
      cg_emergency: "<b>Urgence vitale ?</b> Appelez le <b>14 (SAMU)</b> ou rendez-vous aux urgences. Ce service n'est pas une réponse d'urgence.",
      cg_intro_title: 'Une orientation de confiance',
      cg_intro_p1: "Pour un cas grave ou complexe, trouver le bon spécialiste est décisif. Tabibi vous aide à identifier un praticien compétent en Algérie, et vous oriente vers l'étranger uniquement si c'est réellement nécessaire.",
      cg_trust1_t: 'Cas vérifié.', cg_trust1_d: "Un humain de l'équipe étudie votre situation — pas un algorithme.",
      cg_trust2_t: 'Sans commission.', cg_trust2_d: "Nous n'encaissons rien et ne touchons aucune commission de clinique. L'orientation reste neutre.",
      cg_trust3_t: "Local d'abord.", cg_trust3_d: "Priorité aux spécialistes en Algérie ; l'étranger seulement si le cas l'exige.",
      cg_form_title: 'Décrivez votre cas',
      cg_form_sub: "Renseignez ces informations. À l'envoi, WhatsApp s'ouvre avec votre message pré-rempli vers notre équipe.",
      cg_form_err: 'Merci de renseigner au moins votre nom, votre téléphone et une description.',
      cg_lbl_nom: 'Nom complet', cg_ph_nom: 'Ex. Amina B.',
      cg_lbl_tel: 'Téléphone', cg_ph_tel: 'Ex. +213 6 00 00 00 00',
      cg_lbl_spec: 'Spécialité ou type de problème', cg_ph_spec: 'Ex. oncologie, chirurgie cardiaque, avis complexe...',
      cg_lbl_desc: 'Description du cas', cg_ph_desc: 'Décrivez la situation : diagnostic connu, examens déjà faits, ce dont vous avez besoin...',
      cg_btn_send: 'Envoyer mon cas',
      cg_after_note: 'Joignez vos examens directement sur WhatsApp après l\'envoi.',
      cg_foot_home: 'Accueil', cg_foot_about: 'À propos', cg_foot_privacy: 'Confidentialité', cg_foot_contact: 'Contact',
      foot_casgrave: 'Cas grave',
      ...
      dan_tab_1an: '1 an',
      // « ce mois » était faux dès qu'on cliquait 7j / 90j / 1 an.
      dan_kpi_rdv: 'RDV sur la période',
      dan_kpi_patients: 'Patients uniques',
      dan_kpi_note: 'Note moyenne',
      dan_stable: 'Stable',
      dan_kpi_noshow: 'Taux no-show',
      dan_soon: 'Bientôt disponible',
      dan_no_motifs: 'Aucun motif renseigné sur cette période.',
      dan_insight_empty: 'Aucun RDV sur cette période — les statistiques apparaîtront dès vos premières consultations.',
      dan_load_error: 'Statistiques indisponibles pour le moment. Vérifiez votre connexion et réessayez.',
      // « mensuelle » était faux en 7 j / 90 j : titre rendu neutre.
      dan_chart_monthly: 'Évolution des RDV',
      ...
      dan_week_letter: 'S',
      dan_month_letter: 'M',
      dan_insight_noshow: '⚠️ <b>Taux no-show élevé ({n}%)</b>. Confirmez les RDV par téléphone la veille pour réduire les absences.',
      ...
      // [RADAR P1] Alertes disponibilité
      dw_al_title: 'Mes alertes disponibilité', dw_al_cta: 'Prévenez-moi quand c\'est disponible',
      dw_al_creating: 'Création…', dw_al_ok: 'Alerte en place — on vous préviendra ici dès qu\'une pharmacie signale le médicament.',
      dw_al_fail: 'Impossible de créer l\'alerte. Réessayez.', dw_al_partial: 'Une partie des alertes n\'a pas pu être créée : ',
      dw_al_toomany: 'Limite de 10 alertes actives atteinte — retirez-en une d\'abord.',
      dw_al_inplace: 'Alerte en place — on vous préviendra ici.', dw_al_active: 'Active — on vous préviendra ici.',
      dw_al_notified: 'Signalé disponible par une pharmacie — à confirmer avant de vous déplacer.',
      dw_al_cancel: 'Retirer cette alerte', dw_al_cancelled: 'Alerte retirée.',
      dw_al_cancel_fail: 'Impossible de retirer l\'alerte. Réessayez.', dw_al_err: 'Impossible de charger vos alertes.',
      // [RADAR P1] Radar des pénuries
      dw_rad_title: 'Radar des pénuries',
      dw_rad_src: 'D\'après les demandes des patients sur Tabibi — ce n\'est pas une source officielle. Aucun stock affirmé, aucun prix, aucune donnée personnelle : uniquement des totaux anonymes.',
      dw_rad_top: 'Médicaments introuvables les plus demandés', dw_rad_wil: 'Wilayas les plus en tension',
      dw_rad_7d: '7 jours', dw_rad_30d: '30 jours', dw_rad_all: 'Toutes les wilayas',
      dw_rad_reqs: 'demandes', dw_rad_wilayas: 'wilayas',
      dw_rad_empty: 'Pas encore assez de demandes sur cette période pour établir un signal.',
      dw_rad_err: 'Radar momentanément indisponible.',
      ...
      v4_s3: 'Vos données protégées aux normes européennes (RGPD)',
      v4_s4: 'Conforme RGPD',
      ...
      v4_cp2: 'Données de santé chiffrées — normes européennes (RGPD)',
    ...
    ar: {
      ...
      // [CAS GRAVE 2026] صفحة cas-grave.html
      cg_title_long: 'حالة خطيرة — توجيه موثوق | طبيبي',
      cg_back_home: 'الرئيسية',
      cg_h1: 'حالة خطيرة أو معقّدة؟',
      cg_subtitle: 'يساعدك طبيبي في إيجاد الأخصائي المناسب. حالة مُتحقّق منها، وتوجيه دون أي عمولة.',
      cg_emergency: '<b>حالة طارئة تهدّد الحياة؟</b> اتصل بـ <b>14 (الإسعاف)</b> أو توجّه إلى قسم الاستعجالات. هذه الخدمة ليست استجابة طارئة.',
      cg_intro_title: 'توجيه جدير بالثقة',
      cg_intro_p1: 'في الحالات الخطيرة أو المعقّدة، يكون إيجاد الأخصائي المناسب أمراً حاسماً. يساعدك طبيبي على تحديد طبيب كفء في الجزائر، ولا يوجّهك إلى الخارج إلا عند الضرورة الفعلية.',
      cg_trust1_t: 'حالة مُتحقّق منها.', cg_trust1_d: 'يدرس حالتك شخص من الفريق — وليس خوارزمية.',
      cg_trust2_t: 'دون عمولة.', cg_trust2_d: 'لا نتقاضى أي مبلغ ولا نأخذ أي عمولة من العيادات. يبقى التوجيه محايداً.',
      cg_trust3_t: 'الأولوية للداخل.', cg_trust3_d: 'الأولوية للأخصائيين في الجزائر؛ والخارج فقط إذا استدعت الحالة ذلك.',
      cg_form_title: 'صف حالتك',
      cg_form_sub: 'املأ هذه المعلومات. عند الإرسال، يُفتح واتساب برسالة مُعبّأة مسبقاً موجّهة إلى فريقنا.',
      cg_form_err: 'يرجى إدخال اسمك ورقم هاتفك ووصف الحالة على الأقل.',
      cg_lbl_nom: 'الاسم الكامل', cg_ph_nom: 'مثال: أمينة ب.',
      cg_lbl_tel: 'الهاتف', cg_ph_tel: 'مثال: 00 00 00 00 6 213+',
      cg_lbl_spec: 'التخصص أو نوع المشكلة', cg_ph_spec: 'مثال: الأورام، جراحة القلب، رأي معقّد...',
      cg_lbl_desc: 'وصف الحالة', cg_ph_desc: 'صف الوضع: التشخيص المعروف، الفحوصات المُنجزة، ما تحتاج إليه...',
      cg_btn_send: 'أرسل حالتي',
      cg_after_note: 'أرفق فحوصاتك مباشرة عبر واتساب بعد الإرسال.',
      cg_foot_home: 'الرئيسية', cg_foot_about: 'من نحن', cg_foot_privacy: 'الخصوصية', cg_foot_contact: 'اتصل بنا',
      foot_casgrave: 'حالة خطيرة',
      // [CONFORMITE 2026] doctor-dashboard B1 (statique + 9 cles restaurees)
      my_cabinet: 'عيادتي',
      my_patients: 'مرضاي',
      ...
      dan_tab_1an: 'سنة',
      dan_kpi_rdv: 'مواعيد الفترة',
      dan_kpi_patients: 'مرضى فريدون',
      dan_kpi_note: 'متوسط التقييم',
      dan_stable: 'مستقر',
      dan_kpi_noshow: 'معدل عدم الحضور',
      dan_soon: 'قريباً',
      dan_no_motifs: 'لا يوجد سبب مُسجَّل في هذه الفترة.',
      dan_insight_empty: 'لا مواعيد في هذه الفترة — ستظهر الإحصائيات مع أولى استشاراتك.',
      dan_load_error: 'الإحصائيات غير متاحة حالياً. تحقّق من اتصالك وأعد المحاولة.',
      dan_chart_monthly: 'تطور المواعيد',
      ...
      dan_week_letter: 'أ',
      dan_month_letter: 'ش',
      dan_insight_noshow: '⚠️ <b>معدل عدم حضور مرتفع ({n}%)</b>. أكّد المواعيد هاتفياً قبل يوم واحد لتقليل الغياب.',
      ...
      // [RADAR P1] تنبيهات التوفر
      dw_al_title: 'تنبيهات التوفر', dw_al_cta: 'أعلمني عند توفره',
      dw_al_creating: 'جارٍ الإنشاء…', dw_al_ok: 'تم تفعيل التنبيه — سنعلمك هنا فور إشارة صيدلية إلى توفر الدواء.',
      dw_al_fail: 'تعذّر إنشاء التنبيه. حاول مجددًا.', dw_al_partial: 'تعذّر إنشاء جزء من التنبيهات: ',
      dw_al_toomany: 'بلغت حد 10 تنبيهات نشطة — احذف أحدها أولًا.',
      dw_al_inplace: 'التنبيه مفعّل — سنعلمك هنا.', dw_al_active: 'نشط — سنعلمك هنا.',
      dw_al_notified: 'أشارت صيدلية إلى توفره — يُرجى التأكد قبل التنقل.',
      dw_al_cancel: 'إزالة هذا التنبيه', dw_al_cancelled: 'تمت إزالة التنبيه.',
      dw_al_cancel_fail: 'تعذّرت إزالة التنبيه. حاول مجددًا.', dw_al_err: 'تعذّر تحميل تنبيهاتك.',
      // [RADAR P1] رادار النقص
      dw_rad_title: 'رادار نقص الأدوية',
      dw_rad_src: 'استنادًا إلى طلبات المرضى على طبيبي — هذا ليس مصدرًا رسميًا. لا تأكيد للمخزون، لا أسعار، لا بيانات شخصية: مجاميع مجهولة فقط.',
      dw_rad_top: 'الأدوية المفقودة الأكثر طلبًا', dw_rad_wil: 'الولايات الأكثر تأثرًا',
      dw_rad_7d: '7 أيام', dw_rad_30d: '30 يومًا', dw_rad_all: 'كل الولايات',
      dw_rad_reqs: 'طلبات', dw_rad_wilayas: 'ولايات',
      dw_rad_empty: 'لا توجد طلبات كافية في هذه الفترة لإظهار مؤشر.',
      dw_rad_err: 'الرادار غير متاح مؤقتًا.',
      ...
      v4_s3: 'بياناتك محمية وفق المعايير الأوروبية (RGPD)',
      ...
      v4_cp2: 'بيانات صحية مشفّرة — وفق المعايير الأوروبية (RGPD)',
    ...
    en: {
      ...
      dan_tab_90j: '90 days',
      dan_tab_1an: '1 year',
      dan_kpi_rdv: 'Appointments in period',
      dan_kpi_patients: 'Unique patients',
      dan_kpi_note: 'Average rating',
      dan_stable: 'Stable',
      dan_kpi_noshow: 'No-show rate',
      dan_soon: 'Coming soon',
      dan_no_motifs: 'No reason recorded for this period.',
      dan_insight_empty: 'No appointments in this period — statistics will appear with your first consultations.',
      dan_load_error: 'Statistics unavailable right now. Check your connection and try again.',
      dan_chart_monthly: 'Appointment trend',
      ...
      dan_week_letter: 'W',
      dan_month_letter: 'M',
      dan_insight_noshow: '⚠️ <b>High no-show rate ({n}%)</b>. Confirm appointments by phone the day before to reduce absences.',
      ...
      // [RADAR P1] Availability alerts
      dw_al_title: 'My availability alerts', dw_al_cta: 'Notify me when it\'s available',
      dw_al_creating: 'Creating…', dw_al_ok: 'Alert set — we\'ll notify you here as soon as a pharmacy reports the medication.',
      dw_al_fail: 'Could not create the alert. Please retry.', dw_al_partial: 'Some alerts could not be created: ',
      dw_al_toomany: 'Limit of 10 active alerts reached — remove one first.',
      dw_al_inplace: 'Alert set — we\'ll notify you here.', dw_al_active: 'Active — we\'ll notify you here.',
      dw_al_notified: 'Reported available by a pharmacy — please confirm before travelling.',
      dw_al_cancel: 'Remove this alert', dw_al_cancelled: 'Alert removed.',
      dw_al_cancel_fail: 'Could not remove the alert. Please retry.', dw_al_err: 'Could not load your alerts.',
      // [RADAR P1] Shortage radar
      dw_rad_title: 'Shortage radar',
      dw_rad_src: 'Based on patient requests on Tabibi — this is not an official source. No stock is asserted, no prices, no personal data: anonymous totals only.',
      dw_rad_top: 'Most requested unavailable medications', dw_rad_wil: 'Most affected wilayas',
      dw_rad_7d: '7 days', dw_rad_30d: '30 days', dw_rad_all: 'All wilayas',
      dw_rad_reqs: 'requests', dw_rad_wilayas: 'wilayas',
      dw_rad_empty: 'Not enough requests over this period to establish a signal yet.',
      dw_rad_err: 'Radar temporarily unavailable.',
      ...
      v4_s3: 'Your data protected to European standards (GDPR)',
      ...
      v4_cp2: 'Encrypted health data — European standards (GDPR)',
  ...
  const AUTO = {
    ...
    'Données de santé protégées — normes européennes (RGPD) · Loi 18-07': { ar: 'بيانات صحية محمية — وفق المعايير الأوروبية (RGPD) · القانون 18-07', en: 'Health data protected — European standards (GDPR) · Law 18-07' },
