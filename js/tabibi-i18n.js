...
(function () {
  ...
  const TR = {
    fr: {
      ...
      claim_docs_note: "Vos justificatifs (carte du Conseil de l'Ordre + pièce d'identité) seront à ajouter depuis votre espace médecin, juste après la création de votre compte.",
    ...
    ar: {
      ...
      claim_docs_note: 'سيتعيّن إضافة وثائقك المُثبِتة (بطاقة مجلس النقابة + وثيقة الهوية) من مساحتك كطبيب، بعد إنشاء حسابك مباشرةً.',
    ...
    en: {
      ...
      claim_docs_note: 'Your supporting documents (Medical Council card + ID) will be added from your doctor space, right after creating your account.',
