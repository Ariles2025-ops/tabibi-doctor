...
(function () {
  ...
  const TR = {
    fr: {
      ...
      amb_title:"Devenez <em>Ambassadeur Tabibi</em>",
      amb_sub:"Rejoignez les 50 médecins fondateurs qui lancent Tabibi en Algérie.",
      amb_slots:"places restantes sur 50",
      amb_perk1:"<strong>1 000 DA</strong> versés pour chaque inscription médecin validée que vous parrainez.",
      amb_perk2:"Relooking de la signalétique de votre cabinet aux couleurs Tabibi.",
      amb_perk3:"Votre profil mis en avant en priorité dans les recherches.",
      amb_perk4:"Accès gratuit à vie à toutes les fonctionnalités.",
      amb_form_title:"Candidature ambassadeur",
      amb_commune:"Commune",
      amb_cabinet_address:"Adresse du cabinet",
      amb_consent:"J'accepte les conditions du programme Ambassadeur Tabibi et d'être recontacté(e).",
      amb_submit:"Envoyer ma candidature",
      amb_success_title:"Candidature envoyée !",
      amb_success_msg:"Merci ! Notre équipe vous contactera sous 48h ouvrées. Bienvenue dans l'aventure Tabibi.",
      amb_err_required:"Merci de remplir tous les champs obligatoires.",
      amb_err_consent:"Merci d'accepter les conditions.",
      amb_err_email:"Email invalide.",
      amb_err_captcha:"Vérification anti-robot requise. Réessayez.",
      amb_err_submit:"Échec de l'envoi. Réessayez, ou écrivez à contact@tabibi.doctor.",
      amb_email:"Email",
      amb_sending:"Envoi…",
      cta_ambassador:"Devenez Ambassadeur Tabibi",
      // Header / Navigation
    ...
    ar: {
      ...
      amb_title:"كن <em>سفير طبيبي</em>",
      amb_sub:"انضم إلى الأطباء الخمسين المؤسسين الذين يطلقون طبيبي في الجزائر.",
      amb_slots:"أماكن متبقية من 50",
      amb_perk1:"<strong>1000 دج</strong> لكل تسجيل طبيب مُعتمَد ترعاه.",
      amb_perk2:"تجديد لافتة عيادتك بألوان طبيبي.",
      amb_perk3:"عرض ملفك في مقدمة نتائج البحث بالأولوية.",
      amb_perk4:"وصول مجاني مدى الحياة إلى كل الميزات.",
      amb_form_title:"طلب الترشح كسفير",
      amb_commune:"البلدية",
      amb_cabinet_address:"عنوان العيادة",
      amb_consent:"أوافق على شروط برنامج سفراء طبيبي وعلى أن يتم الاتصال بي.",
      amb_submit:"إرسال ترشحي",
      amb_success_title:"تم إرسال الترشح !",
      amb_success_msg:"شكرًا ! سيتصل بك فريقنا خلال 48 ساعة عمل. مرحبًا بك في مغامرة طبيبي.",
      amb_err_required:"يرجى ملء جميع الحقول الإلزامية.",
      amb_err_consent:"يرجى قبول الشروط.",
      amb_err_email:"بريد إلكتروني غير صالح.",
      amb_err_captcha:"التحقق من أنك لست روبوتًا مطلوب. أعد المحاولة.",
      amb_err_submit:"فشل الإرسال. أعد المحاولة أو راسل contact@tabibi.doctor.",
      amb_email:"البريد الإلكتروني",
      amb_sending:"جارٍ الإرسال…",
      cta_ambassador:"كن سفير طبيبي",
    ...
    en: {
      ...
      amb_title:"Become a <em>Tabibi Ambassador</em>",
      amb_sub:"Join the 50 founding doctors launching Tabibi across Algeria.",
      amb_slots:"spots left out of 50",
      amb_perk1:"<strong>1,000 DA</strong> paid for every validated doctor sign-up you refer.",
      amb_perk2:"A makeover of your practice signage in Tabibi colours.",
      amb_perk3:"Your profile featured first in search results.",
      amb_perk4:"Free lifetime access to all features.",
      amb_form_title:"Ambassador application",
      amb_commune:"Municipality",
      amb_cabinet_address:"Practice address",
      amb_consent:"I accept the Tabibi Ambassador programme terms and to be contacted.",
      amb_submit:"Send my application",
      amb_success_title:"Application sent!",
      amb_success_msg:"Thank you! Our team will contact you within 48 business hours. Welcome to Tabibi.",
      amb_err_required:"Please fill in all required fields.",
      amb_err_consent:"Please accept the terms.",
      amb_err_email:"Invalid email.",
      amb_err_captcha:"Anti-bot verification required. Try again.",
      amb_err_submit:"Submission failed. Try again, or email contact@tabibi.doctor.",
      amb_email:"Email",
      amb_sending:"Sending…",
      cta_ambassador:"Become a Tabibi Ambassador",
